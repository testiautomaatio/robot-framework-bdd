...
Yllä esiintyvät *"The user..."*-alkuiset avainsanat ovat siis *Given-When-Then* -testitapauksen vaiheita vastaavat avainsanat. Robot Frameworkin avainsanat ovat uudelleenkäytettäviä koodilohkoja, joita voidaan kutsua testitapauksissa.
...
Tuotteiden listauksen ja ostamiseen liittyvissä testeissä ei tarvitse käyttää bugisia tunnuksia, vaan `standard_user`-tunnus riittää niihin hyvin.
